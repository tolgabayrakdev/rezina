...
import { Plus, Handshake, Pencil, Trash2, Loader2, Car } from "lucide-react"
...
function InterestForm({ form, setForm, cars, customers, onSubmit, onCancel, saving, isEdit }: InterestFormProps) {
  return (
