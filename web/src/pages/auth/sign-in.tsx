          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-sm">
                <span className="text-foreground font-medium">{email}</span> adresine kod gönderildi
              </p>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <button
                ...
                className="text-primary transition-opacity hover:underline disabled:cursor-not-allowed disabled:no-underline disabled:opacity-40"
              >
